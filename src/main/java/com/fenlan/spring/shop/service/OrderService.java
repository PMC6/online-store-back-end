...
public class OrderService {
     ...
     * @throws Exception
     */
    public List<Order> listByUser(int page, int size, User user) throws Exception{
        Pageable pageable = PageRequest.of(page, size, Sort.by(Sort.Direction.DESC, "createTime"));
     ...
     * @throws Exception
     */
    public int amountUserOrder(String status, User user) throws Exception{
        if (status == null){
     ...
     * @throws Exception
     */
    public List<Order> findOrderBetweenTimes(Date before, Date after) throws Exception{
        ...
        if (orderList.size() == 0) throw new Exception("no product between at this time");
        return orderList;
    }
    ...
    public double findSaleBetweenTimes(Date before, Date after) throws Exception{
        List<Order> orderList = findOrderBetweenTimes(before, after);
        double sale = 0.0;
